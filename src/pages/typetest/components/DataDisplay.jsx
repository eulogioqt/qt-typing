    ...
    return (
        ...
        >
            <span
                ...
                style={{ fontSize: big ? "1.75rem" : "1.25rem", color: "#444444", lineHeight: "1", textWrap: "nowrap" }}
            >
                {name}
            </span>
            ...
            <span
                ...
                style={{ fontSize: big ? "3rem" : "1.75rem", lineHeight: big ? "1" : "1.25", textWrap: "nowrap", cursor: tooltip ? "pointer" : "default" }}
